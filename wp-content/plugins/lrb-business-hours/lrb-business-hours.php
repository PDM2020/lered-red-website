 ...
 * Description:       change business hours widget
 * Version:           1.0.0
 * Author:            John Peacock
...
class LRB_Hours extends WP_Widget {
	...
	public function widget( $args, $instance ) {
		...
		$mon_fri = empty( $instance['mon_fri'] ) ? '' : apply_filters( 'widget_mon_fri', $instance['mon_fri'] );
		$sat = empty( $instance['sat'] ) ? '' : apply_filters( 'widget_sat', $instance['sat'] );
		$sun = empty( $instance['sun'] ) ? '' : apply_filters( 'widget_sun', $instance['sun'] );
